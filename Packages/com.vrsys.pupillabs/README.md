...
2. Add this package, e.g. via Package Manager → "Add package from git URL" pointing at this repo, path `https://github.com/vrsys/VRSYS-PupilLabs-EyeTracking.git?path=/Packages/com.vrsys.pupillabs#v1.1.0` (requires VRSYS-Core, `com.vrsys.core` to already be installed).
